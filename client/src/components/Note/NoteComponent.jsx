...
export function NoteComponent() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div>
        <button
          className="border border-solid border-transparent bg-green px-3 py-1 rounded-sm  hover:bg-white hover:text-green hover:border-green transition-all ease-in-out duration-500 text-green flex items-center gap-3"
